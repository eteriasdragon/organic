...
import {rabet} from "./reducers/rabet.js";

// Reducers
export const rootReducer = combineReducers({products, news, about, reviews, statistics, discounts, organicPros, positions, cart, orders, rabet});
